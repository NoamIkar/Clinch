...
starter.controller("activeClinchController", function($scope, $stateParams, $ionicHistory, clinchService, langService) {
...
starter.controller("activeClinchesController", function($scope, $stateParams, $ionicLoading, clinchService, globalsService) {
    ...
    $scope.$on('$ionicView.enter', function () {
        ...
        function (error) {
            ...
            console.log('In activeClinchesController - Got error = ['+error.code+'] = '+error.message);
            //alert(error.message);
